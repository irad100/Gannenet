...
class Gannenet(Thread):
    ...
    def __init__(self, image_path="images/face_irad.jpg", audio_path="audio/dad.wav", wait_sec=10, apps=["Microsoft Word", "Microsoft Excel", "Spotify", "AdobeAcrobat", "Finder"], is_gui=True):
